    ...
    <head>
        ...
        <title>ArtiMex || Tu sitio artesanal online || Editar artesanía</title>
    </head>
    ...
    <body>
        ...
        <div class="container-fluid">
            <h1 class="text-center my-3">Actualizar producto</h1>
            <div class="row">
                <div class="col-5">
                ...
                <div class="col-7">
                    <form action="add_product.php" method="post" class="form-group my-2">
                        ...
                        <div class="row my-2">
                            <div class="col-3"><input class="form-control" type="text" placeholder="Nombre artista" required></div>
                            <div class="col-3"><input class="form-control" type="text" placeholder="Precio" required></div>
                            <div class="col-3"><input class="form-control disabled" type="text" placeholder="Existencias" min="0"></div>                        
                            <div class="col-3"><input class="form-control" type="number" placeholder="Añadir unidades" min="0" required></div>         
                        </div>
                        <div class="row my-3">
